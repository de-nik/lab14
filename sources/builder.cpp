...
int main(int argc, char *argv[])
{
    ...
    params.add_options()
      ("help", "help message")
      ("config", po::value<std::string>(), "set build configuration")
      ("install", "add installation stage\n(in place _install)")
      ("pack", "add packaging stage\n(in archive format tar.gz)")
      ("timeout", po::value<int>(), "set waiting time (sec)")
    ;
